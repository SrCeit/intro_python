...
cad1=input("Cadena 1:")
cad2=input("Cadena 2:")    
if cad1.find(cad2)>-1: #Si .find devuelve un valor mayor que -1 significa que cadena 2 está dentro de cadena 1
...
'''
Escribir un programa python que dado una palabra diga si es un palíndromo. Un palíndromo es una palabra, número o frase que se lee igual hacia adelante que hacia atrás. Ejemplo: reconocer
'''
cad1=input("Cadena:")    
if cad1.lower()==cad1[::-1].lower(): #::-1 invierte la cadena
        print("Es palindromo")
else:
